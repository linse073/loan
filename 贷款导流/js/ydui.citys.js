    ...
    var citys = [
        {
            ...
            "c": [
                {
                    "a": ["密云区", "朝阳区","朝阳区","昌平区","平谷区","海淀区","西城区","东城区","崇文区","宣武区","丰台区","石景山区","门头沟","房山区","通州区","延庆县","大兴区","顺义区","怀柔区"],
                    "n": "北京"
                }
                /*,
                 {
        ...
        },
        {
            "n": "上海",
            "c": [{
                "a": ["静安区","闸北区","虹口区","杨浦区","徐汇区","长宁区","宝山区","闵行区","嘉定区","浦东新区","青浦区","松江区","金山区","奉贤区","普陀区","黄浦区","崇明县"],
                "n": "上海"
            }
                /*,
                 {
        ...
        },
        {
            "n": "天津",
            "c": [{
                "a": ["东丽区","和平区","河北区","河东区","河西区","红桥区","蓟县","静海县","南开区","塘沽区","西青区","武清区","津南区","汉沽区","大港区","北辰区","宝坻区","宁河县"],
                "n": "天津"
            }
                /*,
                 {
