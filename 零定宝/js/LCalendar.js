 ...
 *//*颜色*/
function Setcolor() {
    var a=parseFloat($('.date_yy').attr('val'));
    var b=parseFloat($('.date_mm').attr('val'));
    var c=parseFloat($('.date_dd').attr('val'));
    /*$($('.date_yy .tooth')[a]).css({'color':'#222',"border-top":"1px solid #F3F3F3","border-bottom":"1px solid #F3F3F3"});
    $($('.date_mm .tooth')[b]).css({'color':'#222',"border-top":"1px solid #F3F3F3","border-bottom":"1px solid #F3F3F3"});
    $($('.date_dd .tooth')[c]).css({'color':'#222',"border-top":"1px solid #F3F3F3","border-bottom":"1px solid #F3F3F3"});*/
}
